...
import style from './module/Post.module.css'
...
const Post = () => {
  ...
  return (
    <div id={style.con}>
      <nav className="navbar navbar-expand-sm bg-dark navbar-dark text-primary">
      ...
      <div className='d-flex-col container pt-4' id={style.bloque}>
        <h1>Create Your Game</h1>
        <form className="border rounded  p-4" id={style.form} onSubmit={e => handleSubmit(e)}>
          <div className="col-6 mb-3 w-auto">
          ...
          <div className="col-6 mb-3 w-auto">
            ...
            <textarea className="form-control" placeholder="Description..." type="text" name="description" value={input.description} onChange={e => handleInput(e)} />
